...
class CreateGlobalMonthlyReportTrxModifierTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('global_monthly_report_trx_modifier', function (Blueprint $table) {
            $table->increments('id_global_monthly_report_trx_modifier');
    ...
    {
        Schema::dropIfExists('global_monthly_report_trx_modifier');
    }
}
