...
class CreateGlobalDailyReportTrxModifierTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('global_daily_report_trx_modifier', function (Blueprint $table) {

            $table->increments('id_global_daily_report_trx_modifier');
    ...
    {
        Schema::dropIfExists('global_daily_report_trx_modifier');
    }
}
