...
namespace Modules\OutletApp\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;

class OutletAppServiceProvider extends ServiceProvider
{
    /**
    ...
    public function registerViews()
    {
        ...
        }, \Config::get('view.paths')), [$sourcePath]), 'outletapp');
    }
    ...
    {
        $langPath = resource_path('lang/modules/outletapp');
