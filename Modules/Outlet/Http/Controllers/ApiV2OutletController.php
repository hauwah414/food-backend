...
class ApiV2OutletController extends Controller
{
    ...
    */
    ...
    public function listOutlet(OutletList $request)
    {
        ...
        if (isset($post['webview'])) {
            ...
            $outlet = Outlet::with(['today', 'brands', 'city'])->select('id_outlet', 'status_franchise', 'outlet_name', 'outlet_code', 'outlet_status', 'id_city', 'time_zone_utc','fee');
        } else {
    ...
    public function detailOutletMerchant(Request $request)
    {
        ...
        if (!empty($post['id_outlet'])) {
            ...
            $bestProduct = app($this->product)->listProductMerchantBestSellers($detail);
            if (!empty($bestProduct)) {
                $detail['id_best'] = array_column($bestProduct, 'id_product');
            }
            $newestProduct = app($this->product)->listProductMerchantNewests($detail);
