...
class XenditServiceProvider extends ServiceProvider
{
    ...
    public function registerViews()
    {
        ...
        }, \Config::get('view.paths')), [$sourcePath]), 'xendit');
    }
    ...
    {
        $langPath = resource_path('lang/modules/xendit');
    ...
    {
        if (! app()->environment('production') && ! app()->environment('staging') && $this->app->runningInConsole()) {
