...
namespace Modules\ShopeePay\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;

class ShopeePayServiceProvider extends ServiceProvider
{
    /**
    ...
    public function registerViews()
    {
        ...
        }, \Config::get('view.paths')), [$sourcePath]), 'shopeepay');
    }
    ...
    {
        $langPath = resource_path('lang/modules/shopeepay');
