...
namespace Modules\UserRating\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;

class UserRatingServiceProvider extends ServiceProvider
{
    /**
    ...
    public function registerViews()
    {
        ...
        }, \Config::get('view.paths')), [$sourcePath]), 'userrating');
    }
    ...
    {
        $langPath = resource_path('lang/modules/userrating');
