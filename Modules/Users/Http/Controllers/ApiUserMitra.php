...
class ApiUserMitra extends Controller
{
    ...
    public function getUserDetail()
    {
        ...
        $merchant = Merchant::where('id_user',$user->id)->join('outlets','outlets.id_outlet','merchants.id_outlet')->first();
        $user['id_merchant']=$merchant->id_merchant;
        $user['id_outlet']=$merchant->id_outlet;
        $user['outlet_code']=$merchant->outlet_code;
        return $user;
    }
