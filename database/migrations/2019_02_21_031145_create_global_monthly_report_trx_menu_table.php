...
class CreateGlobalMonthlyReportTrxMenuTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('global_monthly_report_trx_menu', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('global_monthly_report_trx_menu');
    }
}
