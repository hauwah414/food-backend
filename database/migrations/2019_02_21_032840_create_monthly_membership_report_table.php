...
class CreateMonthlyMembershipReportTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('monthly_membership_report', function (Blueprint $table) {
            $table->increments('id_monthly_membership');
			$table->tinyInteger('mem_month')->nullable();
            $table->year('mem_year')->nullable();
    ...
    {
        Schema::dropIfExists('monthly_membership_report');
    }
}
