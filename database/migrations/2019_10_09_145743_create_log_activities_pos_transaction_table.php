...
class CreateLogActivitiesPosTransactionTable extends Migration
{
    public $set_schema_table = 'log_activities_pos_transaction';
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up()
    {
        ...
        Schema::connection('mysql2')->create($this->set_schema_table, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('id_log_activities_pos_transaction');
