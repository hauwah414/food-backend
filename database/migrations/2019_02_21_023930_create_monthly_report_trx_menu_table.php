...
class CreateMonthlyReportTrxMenuTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('monthly_report_trx_menu', function (Blueprint $table) {
            $table->increments('id_monthly_report_trx_menu');
    ...
    {
        Schema::dropIfExists('monthly_report_trx_menu');
    }
}
