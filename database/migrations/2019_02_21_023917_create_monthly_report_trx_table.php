...
class CreateMonthlyReportTrxTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('monthly_report_trx', function (Blueprint $table) {
            $table->increments('id_monthly_report_trx');
    ...
    {
        Schema::dropIfExists('monthly_report_trx');
    }
}
