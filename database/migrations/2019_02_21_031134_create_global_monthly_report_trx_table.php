...
class CreateGlobalMonthlyReportTrxTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('global_monthly_report_trx', function (Blueprint $table) {
            $table->increments('id_global_monthly_report_trx');
    ...
    {
        Schema::dropIfExists('global_monthly_report_trx');
    }
}
